      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8 mb-12">
          ...
          <div className="bg-white/70 backdrop-blur-xl rounded-2xl shadow-xl border border-white/40 overflow-hidden">
            <div className="aspect-video bg-gradient-to-br from-rose-100/70 to-pink-100/70 backdrop-blur-sm flex items-center justify-center relative">
              ...
              <div className="text-center p-6 sm:p-8 relative z-10">
                ...
                <button className="px-4 sm:px-6 py-2 sm:py-3 bg-gradient-to-r from-rose-500 to-pink-500 text-white rounded-full hover:shadow-lg transition-all duration-500 transform hover:scale-105 text-sm sm:text-base">
                  Open in Maps
                </button>
              </div>
            </div>
          ...
          <div className="space-y-6">
            ...
            {/* Transportation Details - no animation */}
            <div className="bg-white/70 backdrop-blur-xl rounded-2xl p-4 sm:p-6 shadow-xl border border-white/40">
              ...
              <div className="space-y-2 sm:space-y-3 text-xs sm:text-sm text-gray-600">
                <p className="hover:text-gray-800 transition-colors duration-300">• Nearby Airport</p>
                <p className="hover:text-gray-800 transition-colors duration-300">• Train Station</p>
                <p className="hover:text-gray-800 transition-colors duration-300">• Bus Stop</p>
              </div>
            </div>
          </div>
        </div>

        {/* Local Attractions Section with background images and darker fonts */}
        <div className="mb-12">
