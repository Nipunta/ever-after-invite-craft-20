        ...
        <div className="text-center mb-6 md:mb-8 animate-fade-in-stagger">
          <div className="bg-gradient-to-br from-white/95 to-rose-50/80 backdrop-blur-sm rounded-3xl p-6 md:p-8 shadow-lg border border-white/50 max-w-lg mx-auto relative overflow-hidden transform hover:scale-105 transition-all duration-700">
            <div className="relative z-10">
              <h3 className="text-xl md:text-2xl font-elegant text-gray-700 mb-4 animate-typewriter-elegant">
        ...
        <div className="grid lg:grid-cols-2 gap-8 md:gap-12 items-center">
          ...
          <div className="text-center lg:text-left space-y-6 md:space-y-8 order-2 lg:order-1">
            ...
            <div className="space-y-3 md:space-y-4 bg-gradient-to-br from-white/90 to-rose-50/70 backdrop-blur-sm rounded-3xl p-6 md:p-8 shadow-lg border border-white/50 relative overflow-hidden animate-slide-up-elegant">
              <div className="relative z-10">
                <div className="inline-block">
                  <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-script text-transparent bg-clip-text bg-gradient-to-r from-rose-600 via-pink-500 to-amber-500">
                    Save
                  </h1>
                  <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-script text-transparent bg-clip-text bg-gradient-to-r from-amber-500 via-pink-500 to-rose-600">
                    The Date
                  </h1>
                </div>
              </div>
            ...
            <div className="space-y-2 bg-gradient-to-br from-white/95 to-amber-50/70 backdrop-blur-sm rounded-3xl p-6 md:p-8 shadow-lg border border-white/50 relative overflow-hidden animate-slide-up-elegant delay-200">
              <div className="relative z-10">
                <h2 className="text-2xl sm:text-3xl md:text-4xl font-elegant text-gray-700">
                  Sarah & Michael
                </h2>
            ...
            <div className="space-y-6 animate-slide-up-elegant delay-400">
              <div className="bg-gradient-to-br from-white/95 to-pink-50/70 backdrop-blur-sm rounded-3xl p-6 md:p-8 shadow-lg border border-white/50 relative overflow-hidden">
                <div className="relative z-10">
                  <h3 className="text-base md:text-lg font-medium text-gray-600 mb-3 font-elegant">Celebrating Our</h3>
                  <div className="text-2xl md:text-3xl font-script text-gray-800 mb-2">10th</div>
                  <div className="text-lg md:text-xl text-gray-600 mb-4 font-elegant">Wedding Anniversary</div>
                  
                  <div className="space-y-2 text-sm md:text-base text-gray-700">
                    <div className="flex justify-center lg:justify-start items-center space-x-2">
                      <span>📅</span>
                      <span className="font-elegant">June 15, 2025</span>
                    </div>
                    <div className="flex justify-center lg:justify-start items-center space-x-2">
                      <span>🕖</span>
                      <span className="font-elegant">7:00 PM</span>
                    </div>
                    <div className="flex justify-center lg:justify-start items-center space-x-2">
                      <span>📍</span>
                      <span className="text-center lg:text-left font-elegant">Grand Ballroom, The Plaza Hotel</span>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div className="bg-gradient-to-br from-white/90 to-amber-50/70 backdrop-blur-sm rounded-3xl p-6 md:p-8 shadow-lg border border-white/50 relative overflow-hidden animate-slide-up-elegant delay-600">
              <div className="relative z-10">
                <p className="text-base md:text-lg text-gray-600 mb-6 px-2 md:px-0 font-light leading-relaxed font-elegant">
                  Join us for an evening of celebration, love, and memories
                </p>
                <button
                  onClick={onNavigateToInvitation}
                  className="inline-block px-6 md:px-8 py-3 md:py-4 bg-gradient-to-r from-rose-500 to-pink-500 text-white rounded-full shadow-lg hover:shadow-xl transition-all duration-300 hover:from-rose-600 hover:to-pink-600 active:scale-95 text-sm md:text-base transform hover:scale-105"
                >
                  <span className="font-medium flex items-center space-x-2 font-elegant">
