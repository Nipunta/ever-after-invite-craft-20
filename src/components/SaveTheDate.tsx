    ...
    <div className="min-h-screen flex items-center justify-center relative overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto w-full px-4 md:px-6 pt-20 md:pt-24 relative z-20">
        ...
        <div className="text-center mb-8 animate-fade-in-stagger">
          ...
          <LuxuryCard variant="accent" className="max-w-lg mx-auto animate-slide-up-elegant save-date-card">
        ...
        <div className="grid lg:grid-cols-2 gap-8 md:gap-12 items-center">
          ...
          <div className="text-center lg:text-left space-y-6 order-2 lg:order-1">
            {/* Save the Date Card with Animated Shadow Effects */}
            <LuxuryCard variant="primary" delay={200} className="animate-slide-up-elegant save-date-card">
            ...
            {/* Sarah & Alex Card with Animated Shadow Effects */}
            <LuxuryCard variant="secondary" delay={400} className="animate-slide-up-elegant save-date-card">
            ...
            {/* Wedding Details Card - Clean Text with Animated Shadow Effects */}
            <LuxuryCard variant="primary" delay={600} className="animate-slide-up-elegant save-date-card">
            ...
            {/* Call to Action - Enhanced Button with Animated Shadow Effects */}
            <LuxuryCard variant="accent" delay={800} className="animate-slide-up-elegant save-date-card">
              <div className="text-center lg:text-left">
          ...
          {/* Right side - Couple Photo with Enhanced Frame */}
          <div className="flex justify-center lg:justify-end order-1 lg:order-2 animate-fade-in-stagger delay-1000">
            <div className="relative group">
              <div className="relative w-72 h-96 sm:w-80 sm:h-[420px] md:w-96 md:h-[480px] save-date-card">
